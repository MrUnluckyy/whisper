...
const DesktopSidebar: FC<DesktopSidebarProps> = ({ currentUser }) => {
  ...
  return (
    <>
      <div className="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-40 lg:w-20 lg:overflow-y-auto lg:bg-base-300 lg:pb-4 lg:flex lg:flex-col justify-between items-center border-r border-base-300 z-50">
